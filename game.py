...
bird_images = [pygame.image.load(f"{i}.png").convert_alpha() for i in range(3)]
...
flappyhop_images = [pygame.image.load(f"flappyhop{i}.png").convert_alpha() for i in range(1, 5)]

# Загрузка звуков
jump = pygame.mixer.Sound("jump.ogg")
Over = pygame.mixer.Sound("Over.ogg")
zvuk = pygame.mixer.Sound("zvuk.ogg")
Over.set_volume(1)
